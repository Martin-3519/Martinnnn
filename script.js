let classifier;
let imageModelURL = 'https://teachablemachine.withgoogle.com/models/kKAmBZKri/'; // URL del modelo de Teachable Machine
let fileInput;
let label = "";
let img;
...
function handleFile(file) {
  if (file.type === 'image') { // Verifica que el archivo sea una imagen
    ...
    img.size(900, 800); // Establece el tamaño de la imagen
